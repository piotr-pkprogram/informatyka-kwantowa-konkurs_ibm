...
const moveMarkdown = () => src("./src/articles/**/*.md").pipe(dest("app/"));
...
const moveImg = () => src("./src/img/**/*.*").pipe(dest("./dist/img"));
...
const devWatch = () => {
  ...
  watch(
    "./src/components/**/*.pug",
    series(buildIndex, buildSubpages, buildArticles)
  );
...
const prodMoveImg = () => src("./src/img/**/*.*").pipe(dest("./docs/img"));

...
webshim.register("es6", function (a, b, c, d, e) {
  ...
  var f = function f(a) {
    ...
    var t = function t(a, b) {
      ...
      return c || (c = "[object Array]" !== b && null !== a && "object" == _typeof(a) && "number" == typeof a.length && a.length >= 0 && "[object Function]" === o.call(a.callee)), c;
    },
        v = function v(a) {
      if (!w.TypeIsObject(a)) throw new TypeError("bad object");
      return a._es6construct || (a.constructor && w.IsCallable(a.constructor["@@create"]) && (a = a.constructor["@@create"](a)), q(a, {
        _es6construct: !0
      })), a;
    },
        w = {
      CheckObjectCoercible: function CheckObjectCoercible(a, b) {
      ...
      GetIterator: function GetIterator(b) {
        if (u(b)) return new a(b, "value");
        var c = b[s]();
        if (!w.TypeIsObject(c)) throw new TypeError("bad iterator");
        return c;
      },
      ...
      var f = {
        toFloat32: function toFloat32(a) {
          return d(e(a));
        }
      };
    ...
    q(String, {
      fromCodePoint: function fromCodePoint() {
        for (var a, b = m.call(arguments, 0, arguments.length), c = [], d = 0, e = b.length; e > d; d++) {
          if (a = Number(b[d]), !w.SameValue(a, w.ToInteger(a)) || 0 > a || a > 1114111) throw new RangeError("Invalid code point " + a);
      ...
      raw: function raw(a) {
        ...
        for (var i, j, k, l, n = [], o = 0; h > o && (i = String(o), j = f[i], k = String(j), n.push(k), !(o + 1 >= h)) && (j = b[i], j !== e);) {
    ...
    var y = {
      repeat: function () {
        ...
        return function (b) {
          ...
          if (b = w.ToInteger(b), 0 > b || 1 / 0 === b) throw new RangeError("Invalid String#repeat value");
          return a(c, b);
        };
      }(),
      startsWith: function startsWith(a) {
        var b = String(w.CheckObjectCoercible(this));
        if ("[object RegExp]" === o.call(a)) throw new TypeError('Cannot call method "startsWith" with a regex');
        a = String(a);
      ...
      endsWith: function endsWith(a) {
        var b = String(w.CheckObjectCoercible(this));
        if ("[object RegExp]" === o.call(a)) throw new TypeError('Cannot call method "endsWith" with a regex');
        a = String(a);
        var c = b.length,
    ...
    if (z) {
      ...
      q(String.prototype, {
        trim: function trim() {
          if (this === e || null === this) throw new TypeError("can't convert " + this + " to object");
    ...
    D.prototype.next = function () {
      var a = this._s,
          b = this._i;
      if (a === e || b >= a.length) return this._s = e, {
        value: e,
        done: !0
      };
      var c,
      ...
      from: function from(a) {
        ...
        if (b !== e && !w.IsCallable(b)) throw new TypeError("Array.from: when provided, the second argument must be a function");

        for (var f, g = w.IsIterable(d), h = g ? 0 : w.ToLength(d.length), i = w.IsCallable(this) ? Object(g ? new this() : new this(h)) : new Array(h), j = g ? w.GetIterator(d) : null, k = 0; g || h > k; k++) {
          if (g) {
      ...
      this.i = 0, this.array = _a, this.kind = b;
    }, q(a.prototype, {
      next: function next() {
        var a = this.i,
            b = this.array;
        if (a === e || this.kind === e) throw new TypeError("Not an ArrayIterator");
        if (b !== e) for (var c = w.ToLength(b.length); c > a; a++) {
          var d,
              f = this.kind;
      ...
      fill: function fill(a) {
        ...
        for (var g = 0 > b ? Math.max(f + b, 0) : Math.min(b, f), h = 0 > c ? f + c : c, i = g; f > i && h > i; ++i) {
          d[i] = a;
        }
      ...
      find: function find(a) {
        ...
        if (!w.IsCallable(a)) throw new TypeError("Array#find: predicate must be a function");

        for (var d, f = arguments[1], g = 0; c > g; g++) {
          if (g in b && (d = b[g], a.call(f, d, g, b))) return d;
        }
    ...
    q(Number, {
      ...
      getPropertyDescriptor: function getPropertyDescriptor(a, b) {
        for (var c = Object.getOwnPropertyDescriptor(a, b), d = Object.getPrototypeOf(a); c === e && null !== d;) {
          c = Object.getOwnPropertyDescriptor(d, b), d = Object.getPrototypeOf(d);
        }

        return c;
      },
      getPropertyNames: function getPropertyNames(a) {
        for (var b = Object.getOwnPropertyNames(a), c = Object.getPrototypeOf(a), d = function d(a) {
    ...
    var I = function () {
      ...
      "undefined" != typeof c && w.IsCallable(c.postMessage) && (f = function f() {
        var a = [],
            b = "zero-timeout-message",
            d = function d(_d) {
          a.push(_d), c.postMessage(b, "*");
        },
            e = function e(d) {
          if (d.source == c && d.data == b) {
            if (d.stopPropagation(), 0 === a.length) return;
            var e = a.shift();
            e();
          }
        };
      ...
      var i = function i() {
        ...
        return a && a.resolve && function (b) {
          ...
          j = w.IsCallable(b.setImmediate) ? b.setImmediate.bind(b) : "object" == (typeof process === "undefined" ? "undefined" : _typeof(process)) && process.nextTick ? process.nextTick : i() || (w.IsCallable(f) ? f() : function (a) {
        h(a, 0);
      }),
          k = function k(a, b) {
      ...
      a = function a(_a2) {
        var b = this;
        if (b = v(b), !b._promiseConstructor) throw new TypeError("bad promise");
        if (b._status !== e) throw new TypeError("promise already initialized");
        if (!w.IsCallable(_a2)) throw new TypeError("not a valid resolver");
      ...
      return a.all = function (a) {
        ...
        var d = this.constructor,
            e = new g(d);
        w.IsCallable(b) || (b = function b(a) {
          throw a;
        }), w.IsCallable(a) || (a = function a(_a3) {
          return _a3;
        });
        var f = m(c, a, b),
            h = {
    ...
    if (J && K || (b.Promise = I), k) {
      var L = function L(a) {
        ...
        Map: function () {
          ...
          function c(b) {
            var c = this;
            if (c = v(c), !c._es6map) throw new TypeError("bad map");
          ...
          a.prototype.isRemoved = function () {
            ...
            next: function next() {
              ...
              for (; b.next !== d;) {
                if (b = b.next, !b.isRemoved()) return a = "key" === c ? b.key : "value" === c ? b.value : [b.key, b.value], this.i = b, {
                  value: a,
                  done: !1
                };
              }
          ...
          return q(c, {
            ...
            get: function get(a) {
              ...
              for (var d = this._head, f = d; (f = f.next) !== d;) {
                if (w.SameValueZero(f.key, a)) return f.value;
              }
            ...
            has: function has(a) {
              ...
              for (var c = this._head, d = c; (d = d.next) !== c;) {
                if (w.SameValueZero(d.key, a)) return !0;
              }
            ...
            set: function set(b, c) {
              ...
              for (; (f = f.next) !== e;) {
                if (w.SameValueZero(f.key, b)) return void (f.value = c);
              }
            ...
            "delete": function _delete(a) {
              ...
              for (; (c = c.next) !== b;) {
                if (w.SameValueZero(c.key, a)) return c.key = c.value = d, c.prev.next = c.next, c.next.prev = c.prev, this._size -= 1, !0;
              }
            ...
            clear: function clear() {
              ...
              for (var a = this._head, b = a, c = b.next; (b = c) !== a;) {
            ...
            forEach: function forEach(a) {
              for (var b = arguments.length > 1 ? arguments[1] : null, c = this.entries(), d = c.next(); !d.done; d = c.next()) {
        ...
        Set: function () {
          var a = function a(_a4) {
            var b = this;
            if (b = v(b), !b._es6set) throw new TypeError("bad set");

            if (q(b, {
              "[[SetData]]": null,
              _storage: M()
            }), _a4 !== e && null !== _a4) {
              var c = w.GetIterator(_a4),
                  d = b.add;
              if (!w.IsCallable(d)) throw new TypeError("bad set");

...
!function (a) {
  !function () {
    ...
    if (!a.event.special.mousewheel) {
      ...
      if (a.event.fixHooks) for (var i = f.length; i;) {
        a.event.fixHooks[f[--i]] = a.event.mouseHooks;
      }
      a.event.special.mousewheel = {
        version: "3.1.6",
        setup: function setup() {
          if (this.addEventListener) for (var a = g.length; a;) {
            this.addEventListener(g[--a], b, !1);
          } else this.onmousewheel = b;
        },
        teardown: function teardown() {
          if (this.removeEventListener) for (var a = g.length; a;) {
    ...
    if (!a.event.special.mwheelIntent) {
      ...
      i || a(function () {
        ...
        mwheelIntent: function mwheelIntent(a) {
          return a ? this.on("mwheelIntent", a) : this.trigger("mwheelIntent");
        },
        unmwheelIntent: function unmwheelIntent(a) {
    ...
    if (!a.event.special.mousepress) {
      var b = function b(a, _b) {
        ...
        c && clearTimeout(c), _b && a.off("mouseup.mousepressext mouseleave.mousepressext"), a = null;
      };
  ...
  var g = b.picker,
    ...
    _addBindings: function _addBindings() {
      ...
      var i = !1,
          ...
          l = {
        ws__blur: function ws__blur(a) {
          h(a) || d.disabled || d.readonly || h.prevent || (b = !1), p(a);
        },
        ws__focus: function ws__focus() {
          b || (f(), b = this);
        },
        ...
        ws__input: "color" != this.type && this.isValid ? function () {
          var a,
              b = "number" != c.type || d.nogrouping ? 199 : 99,
              e = function e() {
        ...
        "ws__input keydown keypress": function () {
          ...
          return function (b) {
            if (d.splitInput && d.jumpInputs) if ("ws__input" == b.type) {
    ...
    _getSelectionEnd: function _getSelectionEnd(a) {
      var b, c;
  ...
  a.extend(a.fn.wsBaseWidget.wsProto, t), a.extend(a.fn.spinbtnUI.wsProto, t), a(n).on("change", function () {
    ...
    for (c.options.useDecadeBase || (!r[0] && s[0] ? c.options.useDecadeBase = "min" : r[0] && !s[0] && (c.options.useDecadeBase = "max")), "max" == c.options.useDecadeBase && r[0] ? v = 11 - r[0] % 12 : "min" == c.options.useDecadeBase && s[0] && (v = 0 - s[0] % 12), b = 1 * b[0], o = b - (b + v) % (12 * q), d = 0; q > d; d++) {
      for (d ? o += 12 : j = g.isInRange([o - 1], r, s) ? {
        ...
        f = o + e, n = [], !g.isInRange([f], r, s) || z && a(c.orig).triggerHandler("validatevalue", [{
          value: f,
          valueAsDate: null,
          isPartial: [f]
    ...
    for (b = b[0] - Math.floor((s - 1) / 2), d = 0; s > d; d++) {
      for (d ? b++ : l = g.isInRange([b - 1], t, u) ? {
        ...
        h = o.date.monthkeys[e + 1], f = r(e), p = [], !g.isInRange([b, h], t, u) || B && a(c.orig).triggerHandler("validatevalue", [{
          value: b + "-" + h,
    ...
    for (K.setMonth(K.getMonth() - Math.floor((E - 1) / 2)), n = [1 * b[0] + 1, b[1]], n = g.isInRange(n, F, G) ? {
      ...
      for (K.setDate(1), u = K.getMonth(), t = 0, d || (B = new Date(K.getTime()), B.setDate(-1), x = j(B), l = g.isInRange(x, F, G) ? {
        ...
        J.push('<th class="day-' + f + '"><abbr title="' + I.dayNames[f] + '">' + I.dayNamesMin[f] + "</abbr></th>");
      }
    ...
    var e,
        ...
        h,
        j,
        k = '<div class="time-list picker-list ws-index-0">',
        l = 0,
        m = 0,
        n = 23,
        p = {
    ...
    if (!c._commonDateInit) {
      ...
      var f = c.options,
        ...
        e.isDirty && (e.isDirty = !1, d = f.max.split("T"), f.maxS = d[0].split("-"), d[1] && f.maxS.push(d[1]), d = f.min.split("T"), f.minS = d[0].split("-"), d[1] && f.minS.push(d[1]), a("button", e.buttonRow).each(function () {
          var d;
          a(this).hasClass("ws-empty") ? (d = o.date.clear, d || (d = n[""].date.clear || "clear", b.warn("could not get clear text from form cfg"))) : a(this).hasClass("ws-current") && (d = (o[c.type] || {}).currentText, d || (d = (n[""][[c.type]] || {}).currentText || (o.date || {}).currentText || "current", b.warn("could not get currentText from form cfg for " + c.type)), k[c.type] && "time" != c.type && a.prop(this, "disabled", !g.isInRange(k[c.type].split("-"), f.maxS, f.minS) || !!a(c.orig).triggerHandler("validatevalue", [{
            value: k[c.type],

...
webshims.register("form-validation", function (a, b, c, d, e, f) {
  ...
  b.getRelOffset = function (b, c, d) {
    ...
    isInElement: function isInElement(b, c) {
      a.isArray(b) || (b = [b]);
      var d,
          e,
          f,
    ...
    prepareFor: function prepareFor(b, c) {
      ...
      this.lastOpts = h, this.lastElement = a(b).getShadowFocusElement(), this.prepared && this.options.prepareFor || (e = "element" == h.appendTo || h.inline && "auto" == h.appendTo ? c.parent() : "auto" == h.appendTo ? this._getAutoAppendElement(c) : a(h.appendTo), this.prepared && e[0] == this.element[0].parentNode || this.element.appendTo(e)), this.element.attr({
        ...
        "data-id": b.prop("id")
      }), h.constrainWidth ? (this.element.addClass("ws-popover-constrained-width"), g.minWidth = c.outerWidth()) : (this.element.removeClass("ws-popover-constrained-width"), g.minWidth = ""), h.inline ? this.element.addClass("ws-popinline ws-po-visible") : this.element.removeClass("ws-popinline"), this.element.css(g), h.hideOnBlur && (d = function d(a) {
    ...
    return c.element.addClass("validity-alert").attr({
      ...
      hideDelay: 5e3,
      showFor: function showFor(b, c, e, f) {
  ...
  b.errorbox = {
    ...
    get: function get(b, c) {
      ...
      var d,
          e = c.data("errorbox");
      return "object" != (d = _typeof(e)) && (e ? "string" == d && (e = a("#" + e), c.data("errorbox", e, c)) : e = this.create(b, c), this._createContentMessage(b, e, c)), e;
    },
    ...
    hideError: function hideError(b, c) {
      var d,
          e,
          f,
          g = this.getFieldWrapper(b);
      return c || (d = a("input:invalid, select:invalid, textarea:invalid", g)), g.hasClass(t) && (a(b).filter("input").off(".recheckinvalid"), !c && d && d[0] ? a(d).trigger("updatevalidation.webshims") : (e = this.get(b, g), g.removeClass(t), e.message = "", f = function f() {
    ...
    changedvaliditystate: function changedvaliditystate(c) {
      var d;

...
webshims.register('mediaelement-yt', function ($, webshims, window, document, undefined, options) {
  ...
  var _loadYTAPI = function loadYTAPI() {
    if (!window.YT) {
  ...
  var setElementDimension = function setElementDimension(data) {
    var dims;
  ...
  var getYtDataFromElem = function getYtDataFromElem(elem) {
    try {
      elem.nodeName;
    } catch (er) {
      return null;
  ...
  var getYtParams = function getYtParams(src) {
    var found;
  ...
  var handlePlayPauseState = function handlePlayPauseState(state, data) {
    data._ppFlag = true;
  ...
  var addYtAPI = function addYtAPI(mediaElm, elemId, data, ytParams) {
    ytAPI.done(function () {
      var handleBuffered = function handleBuffered() {
        var buffered, bufFac;
      ...
      var getIntervalTime = function getIntervalTime() {
        clearInterval(data._timeInterval);
      ...
      data._ytAPI = new YT.Player(elemId, {
        ...
        events: {
          ...
          'onStateChange': function onStateChange(e) {
            ...
            if (callMeta) {
              $(mediaElm).trigger('durationchange').trigger('loadedmetadata');
            }
  ...
  mediaelement.createSWF = function (mediaElem, src, data) {
    ...
    var box = $('<div class="polyfill-video polyfill-mediaelement ' + webshims.shadowClass + '" id="wrapper-' + elemId + '"><div id="' + elemId + '"></div>').css({
      position: 'relative',
      overflow: 'hidden'
    });
    ...
    setElementDimension(data);
    addYtAPI(mediaElem, elemId, data, ytParams);
    $(mediaElem).on('updatemediaelementdimensions loadedmetadata emptied', setDimension).onWSOff('updateshadowdom', setDimension);
    trigger(data._elem, 'loadstart');
  };

  (function () {
    var triggerUpdate = function triggerUpdate(data) {

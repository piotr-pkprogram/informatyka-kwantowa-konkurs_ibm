...
(function ($) {
  ...
  var extendUndefined = function extendUndefined(prop) {
    for (var i = 0; i < 3; i++) {
  ...
  var extendProps = function extendProps(props) {
    if (props) {
      for (var i in props) {
        if (has.call(props, i)) {
...
})(window.webshims.$); //DOM-Extension helper
...
webshims.register('dom-extend', function ($, webshims, window, document, undefined) {
  ...
  var listReg = /\s*,\s*/; //proxying attribute
  ...
  var singleVal = function singleVal(elem, name, val, pass, _argless) {
  ...
  var elementData = function elementData(elem, key, val) {
  ...
  ['removeAttr', 'prop', 'attr'].forEach(function (type) {
    ...
    extendQ[type] = function (nodeName, prop, desc) {
      ...
      var getSup = function getSup(propType, descriptor, oDesc) {
        var origProp;
  ...
  var extendNativeValue = function () {
    var UNKNOWN = webshims.getPrototypeOf(document.createElement('foobar')); //see also: https://github.com/lojjic/PIE/issues/40 | https://prototype.lighthouseapp.com/projects/8886/tickets/1107-ie8-fatal-crash-when-prototypejs-is-loaded-with-rounded-cornershtc
  ...
  var initProp = function () {
    ...
    webshims.addReady(function (context, contextElem) {
      ...
      var getElementsByName = function getElementsByName(name) {
    ...
    var createNodeNameInit = function createNodeNameInit(nodeName, fn) {
    ...
    return {
      createTmpCache: function createTmpCache(nodeName) {
        if ($.isDOMReady) {
      ...
      content: function content(nodeName, prop) {
      ...
      createElement: function createElement(nodeName, fn) {
        createNodeNameInit(nodeName, fn);
      },
      extendValue: function extendValue(nodeName, prop, value) {
        createNodeNameInit(nodeName, function () {
          $(this).each(function () {
            var data = elementData(this, 'propValue', {});
            data[prop] = this[prop];
  ...
  var createPropDefault = function createPropDefault(descs, removeType) {
  ...
  $.extend(webshims, {
    ...
    prefixed: function prefixed(prop, obj) {
      var i, testProp;
      var ret = false;
    ...
    implement: function implement(elem, type) {
    ...
    extendUNDEFProp: function extendUNDEFProp(obj, props) {
    ...
    getOptions: function () {
      ...
      var regFn = function regFn(f, upper) {
        return upper.toLowerCase();
      };

      var nameFn = function nameFn(f, dashed) {
      ...
      return function (elem, name, bases, stringAllowed) {
        ...
        if (data && _typeof(data[name]) == 'object') {
    ...
    data: elementData,
    moveToFirstEvent: function moveToFirstEvent(elem, eventType, bindType) {
    ...
    propTypes: {
      standard: function standard(descs, name) {
      ...
      "boolean": function boolean(descs, name) {
        createPropDefault(descs);
      ...
      enumarated: function enumarated(descs, name) {
        createPropDefault(descs);
    ...
    reflectProperties: function reflectProperties(nodeNames, props) {
    ...
    defineNodeNameProperty: function defineNodeNameProperty(nodeName, prop, descs) {
    ...
    defineNodeNameProperties: function defineNodeNameProperties(name, descs, propType, _noTmpCache) {
      var olddesc;
      ...
      for (var prop in descs) {
        ...
        if (propType) {
          if (descs[prop][propType]) {//webshims.log('override: '+ name +'['+prop +'] for '+ propType);
          } else {
            descs[prop][propType] = {};
    ...
    createElement: function createElement(nodeName, create, descs) {
      var ret;
    ...
    onNodeNamesPropertyModify: function onNodeNamesPropertyModify(nodeNames, props, desc, only) {
    ...
    defineNodeNamesBooleanProperty: function defineNodeNamesBooleanProperty(elementNames, prop, descs) {
      if (!descs) {
        descs = {};
      }
    ...
    contentAttr: function contentAttr(elem, name, val) {
      if (!elem.nodeName) {
        return;
      }
    ...
    activeLang: function () {
      ...
      var load = function load(src, obj, loadingLang) {
        obj._isLoading = true;
      ...
      var select = function select(obj) {
        ...
        var selectLang = function selectLang(i, lang) {
  ...
  webshims.isReady('webshimLocalization', true); //html5a11y + hidden attribute
  ...
  (function () {
    ...
    var addRole = function addRole(elem, role) {
...
(function ($) {
  ...
  var retDefault = function retDefault(val, def) {
  ...
  var rangeProto = {
    _create: function _create() {
      var i;
      this.element.addClass(this.options.baseClass || 'ws-range ws-input').attr({
        role: 'slider'
      }).append('<span class="ws-range-rail ws-range-track"><span class="ws-range-min ws-range-progress" /><span class="ws-range-thumb"><span><span data-value="" data-valuetext="" /></span></span></span>');
    ...
    value: $.noop,
    _value: function _value(val, _noNormalize, animate) {
      var left, posDif;
      var o = this.options;
      var oVal = val;
      var thumbStyle = {};
    ...
    list: function list(opts) {
      ...
      var that = this;
      this.element.attr({
        'aria-valuetext': o.options[o.value] || o.value
      });
    ...
    normalizeVal: function normalizeVal(val) {
    ...
    doStep: function doStep(factor, animate) {
    ...
    getStepedValueFromPos: function getStepedValueFromPos(pos) {
    ...
    addRemoveClass: function addRemoveClass(cName, add) {
    ...
    addBindings: function addBindings() {
      ...
      var eventTimer = function () {
        var events = {};
        return {
          init: function init(name, curVal, fn) {
            if (!events[name]) {
              events[name] = {
                fn: fn
              };
      ...
      var updateValue = function updateValue(val, animate) {
        if (val != o.value) {
      ...
      var setValueFromPos = function setValueFromPos(e, animate) {
        if (e.type == 'touchmove') {
          e.preventDefault();
          normalizeTouch(e);
        }
      ...
      var removeWin = function removeWin(e) {
        if (e.target == window) {
          remove();
        }
      };
    ...
    posCenter: function posCenter(elem, outerWidth) {
      var temp, eS;
  ...
  var oCreate = function oCreate(o) {
    function F() {}
  ...
  $.fn.rangeUI = function (opts) {
    ...
    return this.each(function () {
      var obj = $.extend(oCreate(rangeProto), {
        element: $(this)
      });
      obj.options = opts;
...
webshims.register('form-number-date-ui', function ($, webshims, window, document, undefined, options) {
  ...
  var getMonthOptions = function getMonthOptions(opts) {
  ...
  var createFormat = function createFormat(name) {
  ...
  var createYearSelect = function createYearSelect(obj, opts) {
  ...
  var labelWidth = function () {
    ...
    return function (element, labels, noFocus) {
      $(element).attr({
        'aria-labelledby': labels.map(getId).get().join(' ')
      });
  ...
  var loadPicker = function loadPicker(type, name) {
  ...
  (function () {
    ...
    var processLangCFG = function processLangCFG(langCfg) {
      if (!langCfg.date.monthkeys) {
        var create = function create(i, name) {
          var strNum;
          var num = i + 1;
    ...
    var triggerLocaleChange = function triggerLocaleChange() {
  ...
  (function () {
    ...
    var formatVal = {
      number: function number(val, o, noCorrect) {
      ...
      time: function time(val, o, noCorrect) {
        var fVal, i;
      ...
      'datetime-local': function datetimeLocal(val, o) {
      ...
      month: function month(val, options) {
        var names;
        var p = val.split('-');
    ...
    var parseVal = {
      ...
      month: function month(val, opts, noCorrect) {
      ...
      date: function date(val, opts, noCorrect) {
        createFormat('d');
        var tmp, obj;
        var ret = '';
    ...
    var createHelper = function () {
      ...
      return function (type) {
        ...
        if (!types[type]) {
          ...
          types[type] = {
            asNumber: function asNumber(val) {
              var type = _typeof(val) == 'object' ? 'valueAsDate' : 'value';
              return input.prop(type, val).prop('valueAsNumber');
            },
            asValue: function asValue(val) {
              var type = _typeof(val) == 'object' ? 'valueAsDate' : 'valueAsNumber';
              return input.prop(type, val).prop('value');
            },
            asDate: function asDate(val) {
              var type = typeof val == 'number' ? 'valueAsNumber' : 'value';
              return input.prop(type, val).prop('valueAsDate');
            },
            isValid: function isValid(val, attrs) {
    ...
    var wsWidgetProto = {
      _create: function _create() {
        ...
        if (steps[this.type] && _typeof(steps[this.type].start) == 'object') {
        ...
        if (o.mirrorValidity) {
          ...
          _timedMirror = function timedMirror() {
            clearTimeout(_timedMirror._timerDealy);
            _timedMirror._timerDealy = setTimeout(_timedMirror._wsexec, 9);
          };

          _timedMirror._wsexec = function () {
            clearTimeout(_timedMirror._timerDealy);
          ...
          $(this.orig).on('change input', function (e) {
            if (e.type == 'input') {
              ...
              _timedMirror._wsexec();
            }
          });
        }
      },
      mirrorValidity: function mirrorValidity(_noTest) {
        //
      ...
      addBindings: function addBindings() {
        ...
        this.inputElements.add(this.buttonWrapper).add(this.element).one('mousedown focusin', function (e) {
          ...
          'change input focus focusin blur focusout': function changeInputFocusFocusinBlurFocusout(e) {
            var oVal, nVal;
        ...
        if (this.type != 'color') {
          (function () {
            ...
            if (!o.splitInput) {
              localeChange = function localeChange() {
                if (o.value) {
      ...
      required: function required(val, boolVal) {
        this.inputElements.attr({
          'aria-required': '' + boolVal
        });
        this.mirrorValidity();
      },
      parseValue: function parseValue(noCorrect) {
      ...
      formatValue: function formatValue(val, noSplit) {
      ...
      placeholder: function placeholder(val) {
        ...
        if (options.splitInput && _typeof(placeholder) == 'object') {
    ...
    var spinBtnProto = $.extend({}, wsWidgetProto, {
      ...
      _beforeValue: function _beforeValue(val) {
      ...
      toFixed: function toFixed(val, force) {
        var o = this.options;
  ...
  if (!$.fn.wsTouchClick) {
    $.fn.wsTouchClick = function () {
      ...
      return function (target, handler) {
        var touchData, _touchEnd, touchStart, stopClick, allowClick;
        ...
        if (addTouch) {
          ...
          _touchEnd = function touchEnd(e) {
            var ret, touch;
            e = e.originalEvent || {};
            $(this).off('touchend touchcancel', _touchEnd);
          ...
          touchStart = function touchStart(e) {
            ...
            elemTarget.on('touchend touchcancel', _touchEnd);
          };
  ...
  (function () {
    ...
    picker.createYearSelect = function (value, max, min, valueAdd, stepper) {
      ...
      var createOption = function createOption(value, add) {
        var value2, label;
    ...
    picker._genericSetFocus = function (element, _noFocus) {
      ...
      if (!this.popover.openedByFocus && !_noFocus) {
        ...
        var setFocus = function setFocus(noTrigger) {
    ...
    picker._actions = {
      changeInput: function changeInput(val, popover, data) {
      ...
      cancel: function cancel(val, popover, data) {
    ...
    picker._common = function (data) {
      ...
      var popover = webshims.objectCreate(options.inlinePicker ? webshims.inlinePopover : webshims.wsPopover, {}, $.extend(options.popover || {}, {
        prepareFor: options.inlinePicker ? data.buttonWrapper : data.element
      }));
      var opener = $('<button type="button" class="ws-popover-opener"><span /></button>').appendTo(data.buttonWrapper);

      var showPickerContent = function showPickerContent() {
      ...
      popover.element.addClass(data.type + '-popover input-picker').attr({
        role: 'application'
      }).on({
      ...
      labelWidth(popover.element.children('div.ws-po-outerbox').attr({
        role: 'group'
      }), options.labels, true);
      ...
      if (options.inlinePicker) {
        ...
        (function () {
          ...
          var resetMouseFocus = function resetMouseFocus() {
            mouseFocus = false;
          };
    ...
    picker['datetime-local'] = picker._common; //		picker.week = picker._common;
    ...
    picker.color = function (data) {
      ...
      var showColor = function showColor() {
        colorIndicator.css({
          backgroundColor: $.prop(this, 'value') || '#000000'
        });
      };
  ...
  (function () {
    ...
    if (options.replaceUI && 'valueAsNumber' in document.createElement('input')) {
      var reflectFn = function reflectFn() {
    ...
    var sizeInput = function sizeInput(data) {
    ...
    var implementType = function implementType() {
      ...
      if (inputTypes[type] && webshims.implement(this, 'inputwidgets') && (!supportInputTypes[type] || !$(this).hasClass('ws-noreplace'))) {
        ...
        opts = $.extend(webshims.getOptions(this, type, [options.widgets, options[type], $($.prop(this, 'form')).data(type)]), {
          ...
          _change: function _change(val, trigger) {
            stopCircular = true;
        ...
        (function () {
          ...
          var hasFocus = false;
          $(data.shim.options.containerElements).on({
            'focusin focus focusout blur': function focusinFocusFocusoutBlur(e) {
              if (e.type == 'focus') {
                e.stopPropagation();
              } else {
                e.stopImmediatePropagation();
    ...
    if (replace.range !== false && (!supportInputTypes.range || replace.range)) {
      extendType('range', {
        _create: function _create(opts, set) {
...
webshims.register('form-datalist', function ($, webshims, window, document, undefined, options) {
  ...
  var lazyLoad = function lazyLoad(name) {
  ...
  (function () {
    ...
    var initializeDatalist = function initializeDatalist() {
      var updateDatlistAndOptions = function updateDatlistAndOptions() {
        var id;
    ...
    webshims.loader.addModule('form-datalist-lazy', {
      ...
      options: $.extend(options, {
        shadowListProto: shadowListProto
      })
    });

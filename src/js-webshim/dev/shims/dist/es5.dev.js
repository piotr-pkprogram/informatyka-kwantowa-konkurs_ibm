...
(function () {
  ...
  var call = FunctionPrototype.call; // Having a toString local variable name breaks in Opera so use _toString.
  ...
  var isArguments = function isArguments(value) {
    ...
    if (!isArgs) {
      isArgs = !isArray(value) && value !== null && _typeof(value) === 'object' && typeof value.length === 'number' && value.length >= 0 && isFunction(value.callee);
    }
  ...
  var owns = call.bind(ObjectPrototype.hasOwnProperty); // If JS engine supports accessors creating shortcuts.
  ...
  }, !spliceWorksWithEmptyObject); // ES5 15.4.4.12
  ...
  defineProperties(ArrayPrototype, {
    ...
    /*, thisp*/
      ...
      var object = toObject(this),
          ...
          result = Array(length),
          thisp = arguments[1]; // If no callback function or if callback is not a callable function
  ...
  defineProperties(Object, {
    keys: function keys(object) {
      var isFn = isFunction(object),
          ...
          isObject = object !== null && _typeof(object) === 'object',
  ...
  defineProperties(Date.prototype, {
    toISOString: function toISOString() {
      ...
      month = this.getUTCMonth(); // see https://github.com/es-shims/es5-shim/issues/111
      ...
      while (length--) {
        value = result[length]; // pad months, days, hours, minutes, and seconds to have two
        // digits.
  ...
  }, hasNegativeDateBug); // ES5 15.9.5.44
  ...
  if (!dateToJSONIsSupported) {
    Date.prototype.toJSON = function toJSON(key) {
      ...
      var o = Object(this),
          tv = toPrimitive(o),
          toISO; // 3. If tv is a Number and is not finite, return null.
  ...
  if (!Date.parse || doesNotParseY2KNewYear || acceptsInvalidDates || !supportsExtendedYears) {
    ...
    Date = function (NativeDate) {
      ...
      Date.prototype.constructor = Date; // Upgrade Date.parse to handle simplified ISO 8601 strings
  ...
  }, hasTrimWhitespaceBug); // ES-5 15.1.2.2
...
(function ($, shims) {
  ...
  var advancedObjectProperties = !!(Object.create && Object.defineProperties && Object.getOwnPropertyDescriptor); //safari5 has defineProperty-interface, but it can't be used on dom-object

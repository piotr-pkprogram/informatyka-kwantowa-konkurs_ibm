...
!function (a) {
  var b = function b() {
    window.asyncWebshims || (window.asyncWebshims = {
      ...
      c = function c() {
    window.jQuery && (a(jQuery), a = function a() {
  ...
  clearInterval(f.timer), k.advancedObjectProperties = k.objectAccessor = k.ES5 = !!("create" in l && "seal" in l), !k.ES5 || "toJSON" in Date.prototype || (k.ES5 = !1), d = a.support.hrefNormalized === !1 ? f._curScript.getAttribute("src", 4) : f._curScript.src, d = d.split("?")[0].slice(0, d.lastIndexOf("/") + 1) + "shims/", a.extend(f, {
    ...
    setOptions: function setOptions(b, c) {
      "string" == typeof b && arguments.length > 1 ? q[b] = a.isPlainObject(c) ? a.extend(!0, q[b] || {}, c) : c : "object" == _typeof(b) && a.extend(!0, q, b);
    },
    _getAutoEnhance: n,
    addPolyfill: function addPolyfill(b, c) {
      c = c || {};
      var d = c.f || b;
    ...
    _polyfill: function _polyfill(b) {
      var d,
          e,
          f = [];
      _c3.run || (d = -1 !== a.inArray("forms-ext", b), _c3(), e = d && !v["form-number-date-ui"].test() || !p && -1 !== a.inArray("mediacapture", b), d && -1 == a.inArray("forms", b) && b.push("forms"), q.loadStyles && w.loadCSS("styles/shim" + (e ? "-ext" : "") + ".css")), q.waitReady && (a.readyWait++, t(b, function () {
        a.ready(!0);
    ...
    capturingEvents: function capturingEvents(b, c) {
    ...
    c: {},
    loader: {
      addModule: function addModule(b, c) {
      ...
      loadList: function () {
        var b = [],
            c = function c(_c2, d) {
          "string" == typeof d && (d = [d]), a.merge(b, d), w.loadScript(_c2, !1, d);
        },
            d = function d(c, _d) {
          if (s(c) || -1 != a.inArray(c, b)) return !0;
          var e,
              f = v[c];
          return f ? (e = f.test && a.isFunction(f.test) ? f.test(_d) : f.test, e ? (s(c, !0), !0) : !1) : !0;
        },
            e = function e(b, c) {
          if (b.d && b.d.length) {
            var e = function e(b, _e) {
              d(_e, c) || -1 != a.inArray(_e, c) || c.push(_e);
            };
        ...
        return function (g) {
          ...
          for (i = 0; i < g.length; i++) {
            h = v[g[i]], h && !d(h.name, g) && (h.css && q.loadStyles && w.loadCSS(h.css), h.loadInit && h.loadInit(), e(h, g), h.loaded || l.push(h.name), h.loaded = !0);
          }

          for (i = 0, j = l.length; j > i; i++) {
            k = !1, h = l[i], -1 == a.inArray(h, b) && ("noCombo" != q.debug && a.each(v[h].c, m), k || c(v[h].src || h, h));
          }
        };
      }(),
      makePath: function makePath(a) {
  ...
  f.addMethodName = function (a) {
    ...
    return t("webshimLocalization", function () {
      ...
      if (a) if ("string" == typeof a) b = a;else if ("object" == _typeof(a)) {
        var c = arguments,
            d = this;
    ...
    a.extend(f, {
      ...
      triggerDomUpdate: function triggerDomUpdate(b) {
  ...
  u("usermedia-core", {
    ...
    var c,
      ...
      return z.bustedValidity = l, c = k[i] && !l ? "form-native-extend" : h, _t = a.noop, !1;
    },
        w = function w(b) {
      var c = !0;
    ...
    f.validationMessages = f.validityMessages = {
      ...
      test: function test(b) {
        return _t(), !k[i] || l || -1 == a.inArray(j, b || []) || v[j].test();
      },
      ...
      test: function test(a) {
        return _t(), !(d.customMessages || !k[i] || l || !v[c].test(a));
      },
      d: [g],
      ...
      test: function test() {
        var a = this.options;
        return a.replaceUI = n(a.replaceUI), _t(), !a.replaceUI && o && (a.replaceUI = !0), !a.replaceUI && w(a);
      },
      ...
      f: "forms",
      test: function test() {
        return _t(), o && (d.customDatalist = !0), k.datalist && !d.fD;
      },
      d: ["form-core", g],

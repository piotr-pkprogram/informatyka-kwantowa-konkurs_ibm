...
window.ActiveXObject && !window.CanvasRenderingContext2D && function (l, k, q) {
  ...
  function w(a, b, c) {
    if (!c) for (var c = [], d = 0, e = a * b * 4; d < e; ++d) {
      c[d] = 0;
    }
    this.width = a;
    this.height = b;
  ...
  function B() {
    if (k.readyState === "complete") {
      ...
      for (var a = k.getElementsByTagName(r), b = 0, c = a.length; b < c; ++b) {
        C.initElement(a[b]);
      }
    }
  }
  ...
  function S() {
    ...
    for (var a in m) {
      ...
      for (d in c) {
        typeof c[d] === "function" && (c[d] = g);
      }

      for (d in b) {
        typeof b[d] === "function" && (b[d] = g);
      }
  ...
  A.prototype = {
    save: function save() {
      this.h(15);
      this.I.push([this.m, this.n, this.w, this.l, this.q, this.o, this.p, this.r, this.u, this.v, this.s, this.t, this.j, this.A, this.B]);
      this.a.push("B");
    },
    ...
    createPattern: function createPattern(a, b) {
      ...
      var c = a.tagName,
          ...
          h = this.e;
      if (c) {
        if (c = c.toLowerCase(), c === "img") d = a.getAttribute("src", 2);else if (c === r) e = this.C(a), f = a !== this.canvas;else if (c === "video") return;else i(17);
    ...
    drawImage: function drawImage(a, b, c, d, e, f, h, ja, l) {
      a || i(17);
      var g = a.tagName,
          k,
          j,
          ...
          o = this.e;
      if (g) {
        if (g = g.toLowerCase(), g === "img") k = a.getAttribute("src", 2);else if (g === r) j = this.C(a), m = a !== this.canvas;else if (g === "video") return;else i(17);
    ...
    createImageData: function createImageData(a, b) {
      var c = Math.ceil;
      arguments.length === 2 ? ((!isFinite(a) || !isFinite(b)) && i(9), (a === 0 || b === 0) && i(1)) : (a instanceof w || i(9), b = a.height, a = a.width);
      a = c(a < 0 ? -a : a);
      b = c(b < 0 ? -b : b);
      return new w(a, b);
    },
    getImageData: function getImageData(a, b, c, d) {
      ...
      a = this.f();
      c = (typeof JSON === "undefined" ? "undefined" : _typeof(JSON)) === "object" ? JSON.parse(a) : k.documentMode ? eval(a) : a.slice(1, -1).split(",");
      a = c.shift();
      b = c.shift();
      return new w(a, b, c);
    },
    putImageData: function putImageData(a, b, c, d, e, f, h) {
      a instanceof w || i(17);
    ...
    loadImage: function loadImage(a, b, c) {
      var d = a.tagName,
          e,
          f = this.e;
      if (d) d.toLowerCase() === "img" && (e = a.getAttribute("src", 2));else if (a.src) e = a.src;
    ...
    h: function h(a) {
      ...
      if (this.s !== this.shadowBlur) b.push("V", this.s = this.shadowBlur);
      ...
      if (a & 2 && this.w !== this.strokeStyle) c = this.w = this.strokeStyle, typeof c === "string" ? (c.indexOf("%") > 0 && this.i.push(b.length + 1), b.push("K", c)) : (c instanceof o || c instanceof x) && b.push("K", c.id);
      ...
      if (a & 8) {
        ...
        if (this.D !== this.canvas.currentStyle.direction) b.push("1", this.D = this.canvas.currentStyle.direction);
      }
    },
    c: function c() {
      var a = this;
      ...
      if (h.length) {
        ...
        if (a) {
          for (b = 0, c = e.length; b < c; ++b) {
            d = e[b], h[d] = encodeURI(h[d]);
          }

          for (b = 0, c = f.length; b < c; ++b) {
            d = f[b], h[d] = encodeURIComponent(h[d]);
          }
        } else for (b = 0, c = f.length; b < c; ++b) {
          d = f[b], h[d] = ("" + h[d]).replace(/&/g, "&amp;").replace(/</g, "&lt;");
        }
    ...
    C: function C(a) {
      ...
      if (b !== this.e && (a = m[b].getContext("2d"), !a.d)) b = ++ba[b], c += ":" + b, a.a.push("3", b), a.b || a.c(), a.d = 1;
      return c;
    },
    k: function k(a) {
      var b = this.e,
